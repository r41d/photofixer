...
#from libxmp import XMPFiles, consts # pip3 install --user python-xmp-toolkit
...
if __name__ == "__main__":
    for file in os.listdir(INPUT):
        ...
        try:
            ...
            make = exif_dict["0th"][271].strip().decode('ascii')
            model = exif_dict["0th"][272].strip().decode('ascii')
